			...
			if(shoot && lastShot == 0){
				if(left && right){
					if(lastDirection==direct.LEFT)
						Map.bullets.add(new Bullet("media/SpearLeft.png", this.getNumPlayer(),22,4));
					if(lastDirection==direct.RIGHT)
						Map.bullets.add(new Bullet("media/SpearRight.png", this.getNumPlayer(),22,4));
				}
				else if (left)
					Map.bullets.add(new Bullet("media/SpearLeft.png", this.getNumPlayer(),22,4));
				else if(right)
					...
					if(lastDirection==direct.UP)
						Map.bullets.add(new Bullet("media/SpearUp.png", this.getNumPlayer(),4,22));
					if(lastDirection==direct.DOWN)
						Map.bullets.add(new Bullet("media/SpearDown.png", this.getNumPlayer(),4,22));
				}
				else if (up)
					Map.bullets.add(new Bullet("media/SpearUp.png", this.getNumPlayer(),4,22));
				else if(down)
